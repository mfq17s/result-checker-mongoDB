...
const Home = () => {
  ...
  return (
    <div
      ...
      } min-h-[100vh] flex flex-col justify-center items-center dark:bg-color-bgc`}
    >
      <div className="w-[100vw] sm:scale-100 scale-75">
        <div className="flex flex-col transition-colors duration-200 items-center">
          <h1 className="mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center tracking-wide dark:text-white">
