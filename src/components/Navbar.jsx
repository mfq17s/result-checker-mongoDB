      ...
      <div className="container px-4 mx-auto text-sm ">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            ...
            <span className="text-xt bg-gradient-to-r from-color-oranges to to-color-blues text-transparent bg-clip-text tracking-tight">
          ...
          <div className="hidden lg:flex justify:center space-x-12 items-center">
            {!dontShowList && (
              <ul className="flex dark:text-white  space-x-12">
